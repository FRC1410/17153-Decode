...
public class Sin implements DynCommand {
    ...
    public Sin(String InID1, String OutID){
        Value1ID = InID1;
        outID = OutID;
    }
    public Sin(String IOID){
        Value1ID = IOID;
        outID = IOID;
    }
    ...
    public void run(){
        ...
        if (out == null) {
            try {
                ...
                throw new DynAutoStepException("org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Sin: failed to create output variable");
            }
        }
        out.setToSin(v1);
    }
    ...
    public String getDescription() {
        return "org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Sin(" + Value1ID + " -> " + outID + ")";
    }
}

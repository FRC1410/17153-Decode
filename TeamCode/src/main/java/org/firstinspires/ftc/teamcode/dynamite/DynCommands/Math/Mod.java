...
public class Mod implements DynCommand {
    ...
    public Mod(String InID1, String InID2, String OutID){
        Value1ID = InID1;
        Value2ID = InID2;
        outID = OutID;
    }
    public Mod(String IOID, String InID){
        Value1ID = IOID;
        Value2ID = InID;
        outID = IOID;
    }
    ...
    public void run(){
        ...
        if (out == null) {
            try {
                ...
                throw new DynAutoStepException("org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Mod: failed to create output variable");
            }
        }
        out.setValue(v1.asDouble() % v2.asDouble());
    }

    @Override
    public String getDescription() {
        return "org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Mod(" + Value1ID + " % " + Value2ID + " -> " + outID + ")";
    }
}

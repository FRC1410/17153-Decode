...
public class Pow implements DynCommand {
    ...
    public void run(){
        ...
        if (out == null) {
            try {
                ...
                throw new DynAutoStepException("org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Pow: failed to create output variable");
            }
        }
        out.setToPow(v1, v2);
    }
    ...
    public String getDescription() {
        return "org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Pow(" + Value1ID + " ^ " + Value2ID + " -> " + outID + ")";
    }
}

...
public class Inv_Tan implements DynCommand {
    ...
    public Inv_Tan(String InID1, String OutID){
        Value1ID = InID1;
        outID = OutID;
    }
    public Inv_Tan(String IOID){
        Value1ID = IOID;
        outID = IOID;
    }
    ...
    public void run(){
        ...
        if (out == null) {
            try {
                ...
                throw new DynAutoStepException("org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Inv_Tan: failed to create output variable");
            }
        }
        out.setToItn(v1);
    }

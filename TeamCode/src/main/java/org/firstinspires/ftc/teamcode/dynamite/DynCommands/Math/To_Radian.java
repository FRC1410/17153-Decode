...
public class To_Radian implements DynCommand {
    ...
    public To_Radian(String InID1, String OutID){
        Value1ID = InID1;
        outID = OutID;
    }
    public To_Radian(String IOID){
        Value1ID = IOID;
        outID = IOID;
    }
    ...
    public void run(){
        ...
        if (out == null) {
            try {
                ...
                throw new DynAutoStepException("org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.To_Radian: failed to create output variable");
            }
        }
        out.setToRadianConvert(v1);
    }

    @Override
    public String getDescription() {
        return "ToRad(" + Value1ID + " -> " + outID + ")";
    }
}

...
public class VFpedroVcalc extends VectorCalculator {
    ...
    private VFpedroPIDFController secondaryTranslationalPIDF;
    private VFpedroPIDFController secondaryTranslationalIntegral;
    private VFpedroPIDFController translationalPIDF;
    private VFpedroPIDFController translationalIntegral;
    private VFpedroPIDFController secondaryHeadingPIDF;
    ...
    public void setConstants(VFpedroFollowerConstants constants) {

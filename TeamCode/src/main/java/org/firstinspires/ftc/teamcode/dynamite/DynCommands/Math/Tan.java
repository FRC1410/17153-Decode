...
public class Tan implements DynCommand {
    ...
    public Tan(String InID1, String OutID){
        Value1ID = InID1;
        outID = OutID;
    }
    public Tan(String IOID){
        Value1ID = IOID;
        outID = IOID;
    }
    ...
    public void run(){
        ...
        if (out == null) {
            try {
                ...
                throw new DynAutoStepException("org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Tan: failed to create output variable");
            }
        }
        out.setToTan(v1);
    }
    ...
    public String getDescription() {
        return "org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Tan(" + Value1ID + " -> " + outID + ")";
    }
}

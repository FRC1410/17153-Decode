...
public class Div implements DynCommand {
    ...
    public Div(String InID1, String InID2, String OutID){
        Value1ID = InID1;
        Value2ID = InID2;
        outID = OutID;
    }
    public Div(String IOID, String InID){
        Value1ID = IOID;
        Value2ID = InID;
        outID = IOID;
    }
    ...
    public void run(){
        ...
        if (out == null) {
            try {
                ...
                throw new DynAutoStepException("org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Div: failed to create output variable");
            }
        }
        out.setToDiv(v1, v2);
    }
    ...
    public String getDescription() {
        return "org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Div(" + Value1ID + " / " + Value2ID + " -> " + outID + ")";
    }
}

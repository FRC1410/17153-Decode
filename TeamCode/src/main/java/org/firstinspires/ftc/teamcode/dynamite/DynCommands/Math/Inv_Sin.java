...
public class Inv_Sin implements DynCommand {
    ...
    public Inv_Sin(String InID1, String OutID){
        Value1ID = InID1;
        outID = OutID;
    }
    public Inv_Sin(String IOID){
        Value1ID = IOID;
        outID = IOID;
    }
    ...
    public void run(){
        ...
        if (out == null) {
            try {
                ...
                throw new DynAutoStepException("org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Inv_Sin: failed to create output variable");
            }
        }
        out.setToIsn(v1);
    }

...
public class ControlSchemeGUI extends JFrame {
    ...
    private ControlMapping[] getDefaultControls(String methodName) {
        ...
        if (methodName.equals("initDriver")) {
            return new ControlMapping[] {
                new ControlMapping("Left Stick X", "DRIVE_STRAFE", "Drive Strafe", ControlType.LEFT_STICK_X),
                new ControlMapping("Left Stick Y", "DRIVE_FB", "Drive Fb", ControlType.LEFT_STICK_Y),
                new ControlMapping("Right Stick X", "DRIVE_ROTATE", "Drive Rotate", ControlType.RIGHT_STICK_X),
                new ControlMapping("A Button", "DRIVE_SLOW_MODE", "Drive Slow Mode", ControlType.A_BUTTON),
            };
        } else {
            return new ControlMapping[] {
                new ControlMapping("Left Trigger", "INTAKE_IN", "Intake In", ControlType.LEFT_TRIGGER),
                new ControlMapping("Right Trigger", "INTAKE_OUT", "Intake Out", ControlType.RIGHT_TRIGGER),
                new ControlMapping("X Button", "SUSAN_MANUAL_ONE", "Susan Manual One", ControlType.X_BUTTON),
                new ControlMapping("A Button", "SUSAN_MANUAL_TWO", "Susan Manual Two", ControlType.A_BUTTON),
                new ControlMapping("B Button", "SUSAN_MANUAL_THREE", "Susan Manual Three", ControlType.B_BUTTON),
                new ControlMapping("Y Button", "SUSAN_LIFT", "Susan Lift", ControlType.Y_BUTTON),
            };
        }
    }

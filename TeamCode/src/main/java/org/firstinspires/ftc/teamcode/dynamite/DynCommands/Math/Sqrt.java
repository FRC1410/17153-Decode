...
public class Sqrt implements DynCommand {
    ...
    public Sqrt(String InID1, String OutID){
        Value1ID = InID1;
        outID = OutID;
    }
    public Sqrt(String IOID){
        Value1ID = IOID;
        outID = IOID;
    }
    ...
    public void run(){
        ...
        if (out == null) {
            try {
                ...
                throw new DynAutoStepException("org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Sqrt: failed to create output variable");
            }
        }
        out.setToSqr(v1);
    }
    ...
    public String getDescription() {
        return "org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Sqrt(" + Value1ID + " -> " + outID + ")";
    }
}

...
public class Mux implements DynCommand {
    ...
    public void run(){
        ...
        if (out == null) {
            try {
                ...
                throw new DynAutoStepException("org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Mux: failed to create output variable");
            }
        }
        out.setToMux(v1, v2);
    }
    ...
    public String getDescription() {
        return "org.firstinspires.ftc.teamcode.dynamite.DynCommands.Math.Mux(" + Value1ID + " * " + Value2ID + " -> " + outID + ")";
    }
}
